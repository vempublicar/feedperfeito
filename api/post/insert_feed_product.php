...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($feedProduct->create($productData)) { // Alterado para $feedProduct->create
        ...
        $_SESSION['status_message'] = 'Produto Feed criado com sucesso!'; // Alterado para Produto Feed
        header('Location: ' . $_SESSION['base_url'] . '/admin/produtos-feed'); // Alterado para produtos-feed
        exit();
    } else {
        $_SESSION['status_type'] = 'error';
        $_SESSION['status_message'] = 'Erro ao criar o Produto Feed.'; // Alterado para Produto Feed
        header('Location: ' . $_SESSION['base_url'] . '/admin/produtos-feed'); // Alterado para produtos-feed
        exit();
    }
} else {
