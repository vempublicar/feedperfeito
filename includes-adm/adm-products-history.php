...
<div class="bg-white rounded-lg shadow-md p-6 mb-8">
    <h3 class="text-lg font-bold text-black mb-4">Histórico de Produtos (Todos os Clientes)</h3>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php if (!empty($user_products)): ?>
                    <?php foreach ($user_products as $product): ?>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-black"><?php echo htmlspecialchars($product['customer_email']); ?></td>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="8" class="px-6 py-4 text-center text-gray-500">Nenhum produto encontrado.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
