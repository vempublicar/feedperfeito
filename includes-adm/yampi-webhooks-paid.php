...
$paid_webhooks = get_yampi_webhooks('order.paid');

?>

<div class="bg-white rounded-lg shadow-md p-6 mb-8">
    <h3 class="text-lg font-bold text-black mb-4">Últimos Pedidos Pagos (order.paid)</h3>
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php if (!empty($paid_webhooks)): ?>
                    <?php foreach ($paid_webhooks as $webhook): ?>
                        <tr>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="8" class="px-6 py-4 text-center text-gray-500">Nenhum webhook de pedido pago encontrado.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
