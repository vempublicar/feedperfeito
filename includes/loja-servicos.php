...
// Catálogo (usando multipleProducts conforme solicitado)
$catalogo = $multipleProducts;
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <div class="flex items-center">
                    ...
                    <select id="filtroUtilization"
                        class="px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent">
                        <option value="">Todos</option>
                        <option value="mais_utilizado">Mais Utilizado (>10)</option>
                        <option value="menos_utilizado">Menos Utilizado (<=10)</option>
                    </select>
                </div>
            </div>
        </div>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function filterProducts() {
            ...
            const filteredProducts = allMultipleProducts.filter(p => {
                ...
                const matchesUtilization = utilizationFilter === '' ||
                                            (utilizationFilter === 'mais_utilizado' && p.utilization > 10) ||
                                            (utilizationFilter === 'menos_utilizado' && p.utilization <= 10);
        ...
        document.getElementById('filtroUtilization').addEventListener('change', filterProducts);
    });
</script>